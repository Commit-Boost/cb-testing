...
//! the P2 config-gen consolidation rationale.
//!
...
pub fn golden(scenario: &str) -> &'static str {
    match scenario {
        ...
        "cb-signer" => include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tests/fixtures/golden-configs/cb-signer.yml"
        )),
        ...
        "cb-ws-stream-filekey" => include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/tests/fixtures/golden-configs/cb-ws-stream-filekey.yml"
        )),
